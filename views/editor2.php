...
<body>
    ...
    <button type="button" class="btn btn-secondary" data-toggle="popover" data-placement="bottom" title="Select Heading">Heading1  </button>
    <div class="dropdown">
        ...
        // }
         function applyHeading(headingType) {
            ...
            if (!selection.isCollapsed) {
                ...
                range = range.extractContents(); ;
                const heading = document.createElement(headingType);
                const newrange = new DOMParser().parseFromString(removeTags(range), "text/html");
                heading.appendChild( newrange.documentElement );
