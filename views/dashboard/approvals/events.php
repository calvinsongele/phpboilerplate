...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    <main class="wrapper">
        ...
        require ADMIN . 'includes/sidebar.inc.php' ?>
            ...
            <div class="content-header"> 
                <a href='#'   class='btn btn-sm btn-primary openmod' >Approve Events</a>
            </div>
                            ...
                            <table class='table table-striped table-hover'>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class='btn btn-sm btn-success approve_event' href='#'   rel='<?= $row['e_ID'] ?>'>Approve</a> 
                                        </td> 
  ...
  <script>
    $(document).ready(function () {
             ...
             $('.approve_event').click(function(e) {
                e.preventDefault();
                var form = new FormData();
                form.append('id', $(this).attr('rel') );  
                
                if (confirm("Are you sure?")) {
                    const data = _data(form, 'approve_event');
