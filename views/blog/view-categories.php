        ...
        <div class='container'>
                    ...
                    <div class='row'> 
                        <div class='col-md-9'>
                             <div class='container'>
            <div class='row'>
                <?php  foreach($this->blog[1][1] as $row) { ?>
                <div class='col-md-4'>
                ...
                <?php } ?>
                     ...
                     <div class="clearfix <?php echo empty($this->blog[0]) ? "hidden" : ""; ?>">
                        ...
                        <div class='col-md-3'>
                            ...
                            <div class='alert card'>
                                <img class='card-img-top' src='/<?= UPLOADS?>/<?= $this->blog[0]['bc_image'] ?>'>
                                <div class='card-body'>
                                    <h3 class='card-heading'><?= $this->blog[0]['bc_name'] ?></h3>
                                    <p><?=  $this->blog[0]['bc_desc']  ?></p>
                                    <a href='/blog/categories/<?= $this->blog[0]['bc_url'] ?>' class='card-heading'>Read more</a>
